...
// @LINE:11
private[this] lazy val controllers_Compctrl_companylist2 = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("company"))))
...
// @LINE:11
case controllers_Compctrl_companylist2(params) => {
   call(params.fromQuery[Int]("p", Some(0)), params.fromQuery[String]("s", Some("name")), params.fromQuery[String]("o", Some("asc")), params.fromQuery[String]("f", Some(""))) { (p, s, o, f) =>
        invokeHandler(controllers.Compctrl.companylist(p, s, o, f), HandlerDef(this, "controllers.Compctrl", "companylist", Seq(classOf[Int], classOf[String], classOf[String], classOf[String]),"GET", """""", Routes.prefix + """company"""))
   }
}
